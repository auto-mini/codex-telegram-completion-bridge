...
try {
    ...
    Write-Output "project_policy_identity_valid=$($readiness.ProjectPolicyIdentityValid.ToString().ToLowerInvariant())"
    Write-Output "project_policy_on_disk=$($readiness.ProjectPolicyOnDisk.ToString().ToLowerInvariant())"
    Write-Output "project_policy_authorized=$($readiness.ProjectPolicyAuthorized.ToString().ToLowerInvariant())"
