...
| Personal exact-hash title-shortening candidate | READY FOR PC2 REQUALIFICATION — exact `personal.4` package/bundle/policy is built and statically verified; no policy or executable applied to PC1 |
